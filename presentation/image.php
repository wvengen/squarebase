<?php
  ...
  function formfield_image($metabasename, $databasename, $field, $value, $readonly) {
    return
      ...
      : html('fieldset', array('class'=>join_clean(' ', $field['presentation'], $readonly ? 'readonly' : null, $field['nullallowed'] ? null : 'notempty')),
          html('ul', array(),
            html('li', array(),
              array(
