...
alter table customers change CustomerID CustomerAcronym varchar(5) not NULL default '';
...
alter table orders change CustomerID CustomerAcronym varchar(5) default '';
